  ...
  return (
    <ul className='text-gr3 w-full flex flex-col items-center text-black gap-4 my-4'>
      <li className='w-gr1 border rounded-full p-2 bg-gradient-to-r from-gold to-mikadoYellow border-black'>
        ...
        >
          <FaLinkedinIn className='size-10 self-start absolute left-1' />
          Linkedin
        </a>
      </li>
      <li className='w-gr1 border rounded-full p-2 bg-gradient-to-r from-gold to-mikadoYellow border-black'>
        ...
        >
          <FaMedium className='size-10 self-start absolute left-1' />
          Medium
        </a>
      </li>
      <li className='w-gr1 border rounded-full p-2 bg-gradient-to-r from-gold to-mikadoYellow border-black'>
        ...
        >
          <FaGithub className='size-10 self-start absolute left-1' />
          GitHub
        </a>
      </li>
    </ul>
